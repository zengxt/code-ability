...
/**
 * 
 * @Description: 一块金条切成两半，是需要花费和长度数值一样的铜板的。比如长度为20的 金条，不管切成长度多大的两半，都要花费20个铜板。一群人想整分整块金 条，怎么分最省铜板？
 ...
 * 输入一个数组，返回分割的最小代价。
 * 
 * 注意：一种错误的思路就是每次从剩余的金条中分出最大的部分。
 *
 * @author： zxt
 *
 * @time: 2018年11月20日 下午5:09:31
 *
 */
public class Code_02_Less_Money {
	...
	/**
	 * 
	 * @Description：哈夫曼树（用堆来实现，优先队列的实现就是一个堆）
	 *                                   
	 * @param arr
	 * @return
	 */
